<div class="text-left">
             ...
             <div class="input-group input-group-sm mb-3">
                 <input id="mail" name="mail" type="mail" class="form-control" value="<?= $detailUserArray ['mail'] ?>" disabled>
             </div>
             ...
             <div class="input-group input-group-sm mb-3">
                 <input id="annonce" name="annonce" type="annonce" class="form-control" value="<?=  $detailUserArray ['title'] ?>" disabled>
             </div>
             ...
             <form action="view-modifyPatients.php" method="POST">
                 <button type="submit" class="btn btn-sm btn-dark" name="modifyPatient" value="<?= $detailUserArray ['id'] ?>">Modifier</button>
