...
<div class="container">
    <div class="bgCard  mb-3 mt-3" style="max-width: 300px h-5">
      <div class="row no-gutters">
        <div class="col-sm">
          <img src="/assets/img/caravane.jpg" class="card-img" alt="caravane ">
        </div>
        <div class="col-sm-8">
          <div class=" test card-body">
            ...
            <p>prix 800 euros</p>
            <button type="button" class="btn btn-success text-white" data-toggle="modal" data-target="#staticBackdrop">En savoir +</button>
          </div>
        </div>
      </div>
    </div>
