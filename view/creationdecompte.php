      ...
      <div class="col border border-dark shadow text-center">
        <form class="creCompte" method="POST" action="creationdecompte.php">
          <div class="form-group   w-100">
            ...
            <input type="text" name="login" class="form-control"  id="login" value="<?= isset($_GET["login"]) ? htmlspecialchars($_GET["login"]) : "" ?>" required>
          ...
          <div class="form-group w-100 ">
            ...
            </div><input type="text" name="mail" class="form-control" id="mail" value="<?= isset($_GET["mail"]) ? htmlspecialchars($_GET["mail"]) : "" ?>" required>
          </div>
          ...
          <div class="form-group w-100">
            ...
            </div><input type="password" name="password" class="form-control" id="password" value="<?= isset($_GET["password"]) ? htmlspecialchars($_GET["password"]) : "" ?>" required>
          </div>
